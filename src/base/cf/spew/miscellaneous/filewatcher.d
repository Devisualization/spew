...
interface IFileSystemWatcher {
	...
	final void onChange(FileSystemWatcherEventFunc func) { onChange = func.toDelegate; }

	void onCreate(FileSystemWatcherEventDel del);
	final void onCreate(FileSystemWatcherEventFunc func) { onCreate = func.toDelegate; }
	void onDelete(FileSystemWatcherEventDel del);
	final void onDelete(FileSystemWatcherEventFunc func) { onDelete = func.toDelegate; }
}