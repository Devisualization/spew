...
interface IWindowEvents : IRenderEvents {
    ...
    @property {
        ...
        /// Ditto
        final void onMove(EventOnMoveFunc func) {
            onMove(func.toDelegate);
        }
        ...
        /// Ditto
        final void onRequestClose(EventOnRequestCloseFunc func) {
            onRequestClose(func.toDelegate);
        }
        ...
        /// Ditto
        final void onKeyPress(EventOnKeyFunc func) {
            onKeyPress(func.toDelegate);
        }
        ...
        /// Ditto
        final void onKeyRelease(EventOnKeyFunc func) {
            onKeyRelease(func.toDelegate);
        }
    }
}
